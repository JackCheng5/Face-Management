package demo.com.facemanagement.twodimension.com;
...
import demo.com.facemanagement.twodimension.com.camera.CameraManager;
import demo.com.facemanagement.twodimension.com.camera.PreviewFrameShotListener;
import demo.com.facemanagement.twodimension.com.camera.Size;
import demo.com.facemanagement.twodimension.com.decode.DecodeListener;
import demo.com.facemanagement.twodimension.com.decode.DecodeThread;
import demo.com.facemanagement.twodimension.com.decode.LuminanceSource;
import demo.com.facemanagement.twodimension.com.decode.PlanarYUVLuminanceSource;
import demo.com.facemanagement.twodimension.com.decode.RGBLuminanceSource;
import demo.com.facemanagement.twodimension.com.util.DocumentUtil;
import demo.com.facemanagement.twodimension.com.view.CaptureView;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback, PreviewFrameShotListener, DecodeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_two_dimension_view);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        if (!mCameraManager.isCameraAvailable()) {
            Toast.makeText(CaptureActivity.this,"Camera disabled", Toast.LENGTH_SHORT).show();
            finish();
            return;
        }
    ...
    public void onDecodeFailed(LuminanceSource source) {
        if (source instanceof RGBLuminanceSource) {
            Toast.makeText(CaptureActivity.this, "No QRCode found!", Toast.LENGTH_SHORT).show();
        }
        isDecoding = false;
        mCameraManager.requestPreviewFrameShot();
    }
