package demo.com.facemanagement.twodimension.com.view;
...
public class CaptureView extends View {
    ...
    private static final int MASK_COLOR = 0x80000000;   //black
    ...
    public void init(Context context) {
        ...
        frameDrawable = getResources().getDrawable(R.mipmap.scan_frame);
        scannerDrawable = getResources().getDrawable(R.mipmap.scan_scaner);
    }
